...
/* harmony import */ var _index_a5d50daf_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-a5d50daf.js */ 7168);
/* harmony import */ var _index_2cf77112_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-2cf77112.js */ 9144);
...
/* harmony import */ var _framework_delegate_fed7fe7c_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./framework-delegate-fed7fe7c.js */ 3912);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_c0b9ca37_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const swipeAnimation = (0,_animation_60dbdd13_js__WEBPACK_IMPORTED_MODULE_9__.c)('toast-swipe-to-dismiss-animation').addElement(wrapperEl)
  /**
  ...
  const gesture = (0,_index_2cf77112_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
    el: wrapperEl,
    gestureName: 'toast-swipe-to-dismiss',
    gesturePriority: _overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.G);
      });
      gesture.enable(true);
    };
    /**
    ...
    this.duration = _ionic_global_ad9a1810_js__WEBPACK_IMPORTED_MODULE_8__.c.getNumber('toastDuration', 0);
  ...
  present() {
    ...
    return (0,_Users_hiteshpatoliya_Documents_personal_Course_masterclass_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_ad9a1810_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_hiteshpatoliya_Documents_personal_Course_masterclass_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  callButtonHandler(button) {
    return (0,_Users_hiteshpatoliya_Documents_personal_Course_masterclass_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler);
          if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    return (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      key: 'c8d7e7d2baa01d3ed5d65a845bc61acf087c0b18',
      tabindex: "-1"
    }, this.htmlAttributes, {
      style: {
      ...
      key: '27c0feeb89c4efb47c42623a4b036ed84338ed10',
      class: wrapperClass
    }, (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '41d5a3069f92e4a6acef2793fa4e236cdbdaae88',
      class: "toast-container",
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
      ...
      key: '176f497bc990ef2ecc14c7fa90dd3a54a912030a',
      class: "toast-content",
      role: "status",
      "aria-atomic": "true",
      "aria-live": "polite"
...
const buttonPart = button => {
  return (0,_overlays_04a9a43f_js__WEBPACK_IMPORTED_MODULE_6__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
