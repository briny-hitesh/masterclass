...
/* harmony import */ var _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-f7dc70ba.js */ 6508);
/* harmony import */ var _ionic_global_ad9a1810_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ionic-global-ad9a1810.js */ 7252);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__.f : _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__.r;
      }
      return checked ? _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__.r : _index_f7dc70ba_js__WEBPACK_IMPORTED_MODULE_8__.g;
    };
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_ad9a1810_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  connectedCallback() {
    ...
    return (0,_Users_hiteshpatoliya_Documents_personal_Course_masterclass_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.legacyFormController = (0,_form_controller_014aa89f_js__WEBPACK_IMPORTED_MODULE_2__.c)(_this2.el);
      /**
  ...
  componentWillLoad() {
    ...
    if (!this.legacyFormController.hasLegacyControl()) {
      this.inheritedAttributes = Object.assign({}, (0,_helpers_c0b9ca37_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el));
    }
  }
  emitStyle() {
    if (this.legacyFormController.hasLegacyControl()) {
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_554688a5_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderToggleControl() {
    const mode = (0,_ionic_global_ad9a1810_js__WEBPACK_IMPORTED_MODULE_9__.b)(this);
    const {
      enableOnOffLabels,
      checked
    } = this;
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    (0,_helpers_c0b9ca37_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    return (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      onClick: this.onClick,
      class: (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_7__.c)(color, {
        [mode]: true,
    ...
    }, this.inheritedAttributes)), (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
        'label-text-wrapper': true,
        'label-text-wrapper-hidden': !this.hasLabel
      },
      part: "label"
    }, (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", null)), (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "native-wrapper"
    }, this.renderToggleControl())));
  }
  renderLegacyToggle() {
    if (!this.hasLoggedDeprecationWarning) {
      (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_4__.p)(`ion-toggle now requires providing a label with either the default slot or the "aria-label" attribute. To migrate, remove any usage of "ion-label" and pass the label text to either the component or the "aria-label" attribute.
...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
      if (this.legacy) {
        (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_4__.p)(`ion-toggle is being used with the "legacy" property enabled which will forcibly enable the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    const {
      ...
      labelId,
      labelText
    } = (0,_helpers_c0b9ca37_js__WEBPACK_IMPORTED_MODULE_3__.e)(el, inputId);
    const value = this.getValue();
    const rtl = (0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_6__.i)(el) ? 'rtl' : 'ltr';
    (0,_helpers_c0b9ca37_js__WEBPACK_IMPORTED_MODULE_3__.d)(true, el, name, checked ? value : '', disabled);
    return (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.H, {
    ...
    }, this.renderToggleControl(), (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
    }, labelText), (0,_index_4c30cddd_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
